define(['jquery'], function () {
    ...
    _form.prototype.iframe = function (url, title) {
        return layer.open({title: title || '窗口', type: 2, area: ['80%', '530px'], fix: true, maxmin: false, content: url});
    };
    ...
    menu.prototype.listen = function () {
        ...
        var $targetmenu = $('.sidebar-fold-xs').on('click', function () {
            var $body = $('.framework-body').toggleClass('framework-sidebar-h5 framework-sidebar-full');
